...
const featureList = [
  {
    ...
    description: "Track daily expenses and income in one place. Organize transactions by category and keep a clear financial history.",
    icon: PlusCircle,
  },
  {
    title: "Reports & Charts",
    description: "Visualize spending and income trends with monthly summaries and category-based reports.",
    icon: PieChart,
  },
  {
    title: "Split Bills with Friends",
    description: "Invite others to share expenses. perfect for trips, meals, and shared living. Automatically calculate who owes what.",
    icon: Users,
  },
  {
    title: "AI Financial Assistant",
    description: "Chat with an AI assistant to get instant insights. Ask where your money went or how much you spent on food.",
    icon: MessageSquare,
  },
  {
    title: "Secure & Private",
    description: "Your data is encrypted and protected. You stay in control of your financial information.",
    icon: ShieldCheck,
  },
  {
    title: "Real-time Sync",
    description: "Access your financial data across all devices with real-time cloud synchronization.",
    icon: Zap,
  }
];
    ...
    <section id="features" className="py-24 md:py-32 bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter">
              AI-Powered <span className="text-primary italic">Receipt Tracking</span>
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Upload receipts and let Arta's AI automatically extract amounts, categories, dates, and merchants. No manual input required.
            </p>
        ...
        <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tighter">Everything you need</h2>
          <p className="text-lg text-muted-foreground">Arta is packed with features to make financial management simple and collaborative.</p>
        </div>
